  ...
  const CampaignDetails = ({ campaignId, children }: { 
    ...
    const { data: status = 'LOADING' } = useReadContract({
      ...
      args: [BigInt(campaignId)],
         ...
         const formattedContribution = formatPSGAmount(contribution);
